...
const Home = () => {
  return (
    <div className="dark:text-white w-[40%] h-auto flex flex-col justify-center  items-center mx-auto gap-28 mt-28">
      ...
      <div className="w-full  h-auto flex flex-col gap-10">
        <hr className="border-gray-300 dark:border-[#1f1f1f]" />
